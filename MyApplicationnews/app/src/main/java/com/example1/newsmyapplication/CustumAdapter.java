...
public class CustumAdapter extends RecyclerView.Adapter<CustomViewHolder>{
    private Context context;
    private List<Newsheadline> headlines;
    private SelectListener listener;

    public CustumAdapter(Context context, List<Newsheadline> headlines, SelectListener listener) {
